...
#define M 4
	...
	static float xbuff[M+1]={0};             //Zeros?
	static float b[M+1] ={0.01488697472657, -0.02695899404537,  0.03705935223574, -0.02695899404537,
		0.01488697472657};			 //Initierar b koefficienterna till 1/(M+1).
